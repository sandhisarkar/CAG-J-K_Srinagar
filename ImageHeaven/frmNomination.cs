    ...
    public partial class frmNomination : Form
    {
        ...
        private void deTextBox9_Leave(object sender, EventArgs e)
        {
            if (_mode == Mode._Add)
            {
                ...
                checkFileNotExists(filename, deTextBox4.Text.ToString(), deTextBox5.Text.ToString());
            }
            if (_mode == Mode._Edit)
            {
                if (currStage == "Entry")
                {
                    ...
                    {
                        checkFileNotExistsEdit(filename, deTextBox4.Text.ToString(), deTextBox5.Text.ToString());
                    }
                }
                if (currStage == "FQC")
                {
