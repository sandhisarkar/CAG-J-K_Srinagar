...
namespace ImageHeaven
{
    public partial class aeFQC : Form, IMessageFilter
    {
        ...
        public DataTable getFileDetails(string projKey, string bundleKey, string file_no)
        {
            ...
            string sql = "select filename, state_name, pension_file_no,rule_file,vol,series,acc,emp_name from metadata_entry where proj_code = '" + projKey + "' and batch_key = '" + bundleKey + "' and filename = '" + file_no + "'";
