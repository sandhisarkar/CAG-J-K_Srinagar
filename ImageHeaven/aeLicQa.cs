    ...
    public partial class aeLicQa : Form
    {
            ...
            try
            {
                if (Convert.ToInt32(textBox1.Text) < 100)
                {
                    if (prmState.Length == 0)
                    {
                        ...
                        "a.ledger_year,date_format(a.accept_date,'%Y-%m-%d'),a.fp_auth_no,date_format(a.fp_date,'%Y-%m-%d'),a.status from metadata_entry A where a.proj_code=" + projCode + " and a.batch_key=" + batchCode + " order by rand() limit " + limit;
                    }
                    else
                    {
                        ...
                        sqlStr = "select a.filename,a.department,a.subcat,a.state_name,a.emp_name,a.desg,a.fileid,date_format(a.birth_date,'%Y-%m-%d'),date_format(a.joining_date,'%Y-%m-%d'),date_format(a.death_date,'%Y-%m-%d')," +
                            "date_format(a.retirement_date,'%Y-%m-%d'),a.psa_name,a.section,a.pension_file_no,a.ppo_fppo,a.gpo_dgpo,a.ppo_gpo_cpo,a.mobile,a.hrms_id,a.spouce,a.place_payment,a.rule_file,a.vol,a.subject,a.series,a.acc,a.subscriber_name," +
                            "a.ledger_year,date_format(a.accept_date,'%Y-%m-%d'),a.fp_auth_no,date_format(a.fp_date,'%Y-%m-%d'),a.status from metadata_entry A where a.proj_code=" + projCode + " and a.batch_key=" + batchCode;
                ...
                else
                {
                    if (prmState.Length == 0)
                    {
                        sqlStr = "select a.filename,a.department,a.subcat,a.state_name,a.emp_name,a.desg,a.fileid,date_format(a.birth_date,'%Y-%m-%d'),date_format(a.joining_date,'%Y-%m-%d'),date_format(a.death_date,'%Y-%m-%d')," +
                            "date_format(a.retirement_date,'%Y-%m-%d'),a.psa_name,a.section,a.pension_file_no,a.ppo_fppo,a.gpo_dgpo,a.ppo_gpo_cpo,a.mobile,a.hrms_id,a.spouce,a.place_payment,a.rule_file,a.vol,a.subject,a.series,a.acc,a.subscriber_name," +
                            "a.ledger_year,date_format(a.accept_date,'%Y-%m-%d'),a.fp_auth_no,date_format(a.fp_date,'%Y-%m-%d'),a.status from metadata_entry A where a.proj_code=" + projCode + " and a.batch_key=" + batchCode + " order by a.item_no asc limit " + limit;
                    }
                    else
                    {
        ...
        void PolicyDetails(string prmBoxNo)
        {
            ...
            if ((prmBoxNo != string.Empty) && (prmBoxNo != null) && (cmbProject.SelectedValue.ToString() != string.Empty) && (cmbProject.SelectedValue.ToString() != null) && (cmbBatch.SelectedValue.ToString() != string.Empty) && ((cmbBatch.SelectedValue.ToString() != null)))
            {
                        ...
                        if (totSize != String.Empty)
                        {
                            ...
                            if (Convert.ToDouble(totFileSize) > ihConstants._DOCKET_MAX_SIZE)
                            {
                                if ((Convert.ToInt32(dsPolicy.Tables[0].Rows[i]["status"].ToString()) != (int)eSTATES.POLICY_SCANNED) && (Convert.ToInt32(dsPolicy.Tables[0].Rows[i]["status"].ToString()) != (int)eSTATES.POLICY_QC) && (Convert.ToInt32(dsPolicy.Tables[0].Rows[i]["status"].ToString()) != (int)eSTATES.POLICY_ON_HOLD))
                                {
                                    ...
                                    dr["Spouce"] = dsPolicy.Tables[0].Rows[i][19].ToString();
                ...
                if ((grdPolicy.Rows.Count > 0))
                {
                    ...
                    {
                        if (Convert.ToInt32(grdPolicy.Rows[l].Cells[35].Value.ToString()) == (int)eSTATES.POLICY_CHECKED)
                        {
                        ...
                        if ((Convert.ToInt32(grdPolicy.Rows[l].Cells[35].Value.ToString()) == (int)eSTATES.POLICY_EXCEPTION) || (Convert.ToInt32(grdPolicy.Rows[l].Cells[35].Value.ToString()) == (int)eSTATES.POLICY_EXCEPTION))
                        {
                            grdPolicy.Rows[l].DefaultCellStyle.ForeColor = Color.Black;
                            grdPolicy.Rows[l].DefaultCellStyle.BackColor = Color.Red;
                        }
                        if ((Convert.ToInt32(grdPolicy.Rows[l].Cells[35].Value.ToString()) == (int)eSTATES.POLICY_ON_HOLD))
                        {
                            grdPolicy.Rows[l].DefaultCellStyle.ForeColor = Color.Black;
                            grdPolicy.Rows[l].DefaultCellStyle.BackColor = Color.Turquoise;
                        }
                        if ((Convert.ToInt32(grdPolicy.Rows[l].Cells[35].Value.ToString()) == (int)eSTATES.POLICY_MISSING))
                        {
                            grdPolicy.Rows[l].DefaultCellStyle.ForeColor = Color.Black;
                ...
                if (dt.Rows.Count > 0)
                {
                    grdPolicy.Columns[35].Visible = false;
        ...
        private void grdPolicy_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (Convert.ToDouble(grdPolicy.Rows[e.RowIndex].Cells[32].Value.ToString()) > 0)
                {

                    lblTotFiles.Text = Convert.ToString(Math.Round(Convert.ToDouble(grdPolicy.Rows[e.RowIndex].Cells[32].Value.ToString()), 2));
                    lblAvgSize.Text = Convert.ToString(Math.Round(Convert.ToDouble(grdPolicy.Rows[e.RowIndex].Cells[33].Value.ToString()), 2)) + " KB";
                    lblDock.Text = Convert.ToString(Math.Round(Convert.ToDouble(grdPolicy.Rows[e.RowIndex].Cells[34].Value.ToString()), 2)) + " KB";
                    policyStatus = Convert.ToInt32(grdPolicy.Rows[e.RowIndex].Cells[35].Value.ToString());
