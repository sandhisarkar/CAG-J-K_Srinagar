        ...
        private void lstDeeds_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (lstDeeds.SelectedItems.Count > 0)
            {
                ...
                if(category == "Pension Case File")
                {
                    ...
                    string dob = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][10].ToString();
                    string doj = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][11].ToString();
                    string dod = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][12].ToString();
                    string dor = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][13].ToString();
                    string psa = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][14].ToString();
                    string sec = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][15].ToString();
                    string fileno = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][16].ToString();
                    string ppo = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][17].ToString();
                    string gpo = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][18].ToString();
                    string mobile = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][20].ToString();
                    string hrms = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][21].ToString();
                    string spouce = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][22].ToString();
                ...
                else if(category == "Pension Case Registers")
                {
                    ...
                    string fileno = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][16].ToString();
                    string ppo = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][19].ToString();
                    
                    string place = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][23].ToString();
                ...
                {
                    string state = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][6].ToString();
                    string fileno = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][24].ToString();
                    string vol = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][25].ToString();
                    string subject = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][26].ToString();
                ...
                {
                    string state = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][6].ToString();
                    string series = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][27].ToString();
                    string acc = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][28].ToString();
                    string name = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][29].ToString();
                    string dob = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][10].ToString();
                    string year = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][30].ToString();
                ...
                else if(category == "Nomination")
                {
                    ...
                    string name = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][29].ToString();
                    string dob = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][10].ToString();
                    string doa = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][31].ToString();
                    string mobile = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][20].ToString();
                    string hrms = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][21].ToString();
                ...
                else if(category == "Final Payment Case File")
                {
                    ...
                    string mobile = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][20].ToString();
                    string hrms = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][21].ToString();
                    string authno = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][32].ToString();
                    string fpdate = _GetFileCaseDetailsIndividual(projKey, bundleKey, filename).Rows[0][33].ToString();
