    ...
    public partial class frmExport : Form
    {
        ...
        public System.Data.DataTable GetAllDeedEX(string proj_key, string batch_key)
        {
            ...
            sqlStr = "SELECT b.batch_code as 'BatchNumber',a.filename as 'FileName', a.state_name as 'StateName', a.department as 'Department'," +
                    ...
                    "a.mobile as 'MobileNumber', a.hrms_id as 'HRMS_ID', a.spouce as 'Spouce', a.place_payment as 'PlaceOfPayment', a.rule_file as 'RuleFile'," +
                    ...
                    "DATE_FORMAT(a.fp_date, '%d-%m-%Y') as 'FP_Date' FROM metadata_entry a,batch_master b where a.proj_code = b.proj_code and a.batch_key = b.batch_key and a.proj_code = '" + proj_key + "' and a.batch_key = '" + batch_key + "'";
            try
            {
                sqlAdap = new OdbcDataAdapter(sqlStr, sqlCon);
                sqlAdap.Fill(dsImage);
